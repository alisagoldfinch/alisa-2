 ...
 */
{
	...
	class Slideshow {
		constructor(el) {
			...
			this.slides = []
			;[
				...this.DOM.el.querySelectorAll('.grid__item--slide')
			].forEach((slide, pos) =>
				this.slides.push(new Slide(slide, this.DOM.titles[pos]))
			)
		...
		setVisibleSlides() {
			...
			this.rightSlide = this.slides[
				this.center + 1 <= this.slidesTotal - 1 ? this.center + 1 : 0
			]
			this.leftSlide = this.slides[
